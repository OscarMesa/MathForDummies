...
<!--        <script src="<?php echo Yii::app()->baseUrl; ?>/js/jquery.tools.min.js"></script>-->
    ...
    <body>
        <div id="cargando" class="alert alert-warning procesando alert-block" style="display: none;"><img src="<?php echo Yii::app()->baseUrl . '/themes/OzAuLink/images/ajax-loader.gif';?>"/> <?php echo Yii::t('polimsn', 'Processing , Please wait a moment...') ?> </div>
        <div  class="grid_16">
            <?php
