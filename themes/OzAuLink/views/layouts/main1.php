...
<!--        <script src="<?php echo Yii::app()->baseUrl; ?>/js/jquery.tools.min.js"></script>-->
    ...
    <body>
        <div id="cargando" class="alert alert-warning procesando alert-block" style="display: block;"><img src="<?php echo Yii::app()->getBaseUrl();?>/themes/OzAuLink/images/ajax-loader.gif"> <?php echo Yii::t('polimsn', 'Processing , Please wait a moment...') ?> </div>
        <div id="footer">
