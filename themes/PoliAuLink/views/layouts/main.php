        ...
        <div id="curso">
            ...
            <div id="panel_central">
                <div id="menu">
                    ...
                    ?>
                    <div id="op" class='activo'><a href="<?php Yii::app()->getBaseUrl(true)?>/cursos/admin">Curso</a></div>
                    <div id="op"><a href="<?php Yii::app()->getBaseUrl(true)?>/talleres/admin">Talleres</a></div>
