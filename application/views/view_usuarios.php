...
<form class="form-search frm-search-math" id="frm-search-usuarios">
  <div class="input-append">
    <input type="text" class="span2 search-query" id="input-search-user" placeholder="Buscar usuario">
    <button type="submit" id="serach-usuario" class="btn" title="Filtre por cualquier campo">Buscar</button>
  </div>
</form>
<div id="ContentList">
...
<div id="message-delte-user" class="modal hide fade" style="display: none;" >
    <div class="modal-header">
      ...
      <div class="modal-footer">
        <a href="#" id="btn-deleteurse" class="btn btn-success">Aceptar</a>
