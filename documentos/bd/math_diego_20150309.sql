...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-03-2015 a las 01:42:21
...
CREATE TABLE IF NOT EXISTS `comentarios_curso` (
  ...
  KEY `fk_Comentarios_curso_cursos1_idx` (`idcurso`) USING BTREE,
  KEY `fk_Comentarios_curso_usuarios1_idx` (`idusuario`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `comentarios_evaluacion` (
  ...
  KEY `fk_comentarios_evaluacion_usuarios1_idx` (`idusuario`) USING BTREE,
  KEY `fk_comentarios_evaluacion_evaluaciones1_idx` (`idevaluacion`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `comentarios_taller` (
  ...
  KEY `fk_comentarios_taller_usuarios1_idx` (`idusuario`) USING BTREE,
  KEY `fk_comentarios_taller_talleres1_idx` (`idtaller`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `contenidos_ejercicio` (
  ...
  KEY `fk_contenidos_has_ejercicios_ejercicios1` (`ejercicios_id`) USING BTREE,
  KEY `fk_contenidos_has_ejercicios_contenidos1` (`contenidos_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `contenidos_talleres` (
  ...
  KEY `fk_contenidos_has_talleres_talleres1_idx` (`talleres_idtalleres`) USING BTREE,
  KEY `fk_contenidos_has_talleres_contenidos1_idx` (`contenidos_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `cursos` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_cursos_docentes1` (`id_docente`) USING BTREE,
  KEY `fk_cursos_materias1_idx` (`idmateria`) USING BTREE,
  KEY `cursos_fk_grado` (`id_grado`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Campo que vincula el curso a un grado escolar.' AUTO_INCREMENT=8 ;
...
(4, 'active', 1, 1, 'kkjkkjjkkjklk kjjk', 'hhjhjhjhjhj', '2014-04-04', '2014-09-04', NULL, 1),
(5, 'active', 1, 1, 'Curso 1', 'esta es la descripcion.', '2014-05-01', '2014-09-07', NULL, 1),
(6, 'active', 1, 1, 'prueba', 'prueba de creacion de cruso.', '2014-09-30', '2015-02-28', NULL, 1),
(7, 'active', 1, 2, 'orientacion', 'zdzdf sf sdfsf sdfsdf sdfsdfsf sdf sdfdsfd', '2014-11-26', '2015-01-31', 1, 1);
...
CREATE TABLE IF NOT EXISTS `cursos_evaluaciones` (
  ...
  KEY `fk_cursos_has_evaluaciones_evaluaciones1_idx` (`evaluaciones_id`) USING BTREE,
  KEY `fk_cursos_has_evaluaciones_cursos1_idx` (`cursos_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `cursos_juego` (
  ...
  KEY `fk_cursos_has_juego_juego1_idx` (`juego_idjuego`) USING BTREE,
  KEY `fk_cursos_has_juego_cursos1_idx` (`cursos_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `cursos_talleres` (
  ...
  KEY `fk_cursos_has_talleres_talleres1_idx` (`talleres_idtalleres`) USING BTREE,
  KEY `fk_cursos_has_talleres_cursos1_idx` (`cursos_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `ejercicios` (
  ...
  KEY `fk_ejercicios_tema1_idx` (`idtema`) USING BTREE,
  KEY `fk_ejercicios_usuarios1_idx` (`idusuariocreador`) USING BTREE,
  KEY `fk_ejercicios_usuarios2_idx` (`IdDocente`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `ejercicios_ecuaciones` (
  ...
  KEY `fk_ejercicios_has_Ecuaciones_Ecuaciones1` (`Ecuaciones_id_ecuacion`) USING BTREE,
  KEY `fk_ejercicios_has_Ecuaciones_ejercicios1` (`ejercicios_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `ejercicios_evaluaciones` (
  ...
  KEY `fk_ejercicios_has_evaluaciones_evaluaciones1_idx` (`evaluaciones_id`) USING BTREE,
  KEY `fk_ejercicios_has_evaluaciones_ejercicios1_idx` (`ejercicios_id_ejercicio`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `ejercicios_respuestaejercicio` (
  ...
  KEY `fk_ejercicios_has_RespuestaEjercicio_RespuestaEjercicio1_idx` (`RespuestaEjercicio_idRespuestaEjercicio`) USING BTREE,
  KEY `fk_ejercicios_has_RespuestaEjercicio_ejercicios1_idx` (`ejercicios_id_ejercicio`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `ejercicios_talleres` (
  ...
  KEY `fk_ejercicios_has_talleres_talleres1_idx` (`talleres_idtalleres`) USING BTREE,
  KEY `fk_ejercicios_has_talleres_ejercicios1_idx` (`ejercicios_id_ejercicio`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `evalucacion_integrante` (
  ...
  KEY `fk_evalucacion_integrante_integrantes_curso1` (`id_integrante_curso`) USING BTREE,
  KEY `fk_evalucacion_integrante_evaluaciones1` (`id_evaluacion`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `img_videos_sonido` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_img_videos_sonido_usuarios1_idx` (`idUsiario`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `img_videos_sonido_contenidos` (
  ...
  KEY `fk_img_videos_has_contenidos_contenidos1_idx` (`contenidos_id`,`contenidos_tipo_contenido_id`) USING BTREE,
  KEY `fk_img_videos_has_contenidos_img_videos1_idx` (`img_videos_id`) USING BTREE,
  KEY `fk_img_videos_has_contenidos_contenidos1_idx1` (`contenidos_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `integrantes_curso` (
  ...
  KEY `fk_usuarios_has_cursos_cursos1` (`cursos_id`) USING BTREE,
  KEY `fk_integrantes_curso_usuarios1` (`id_integrante`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `materias_docente` (
  ...
  KEY `fk_materias_has_usuarios_usuarios1_idx` (`usuarios_id_usuario`) USING BTREE,
  KEY `fk_materias_has_usuarios_materias1_idx` (`materias_idmaterias`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `math_authassignment` (
  ...
  KEY `fk_math_authassignment_math_authitem1` (`itemname`) USING BTREE,
  KEY `fk_math_authassignment_user` (`userid`) USING BTREE
...
('action_contenidos_nuevocontediomediacurso', 0, '', NULL, 'N;'),
('action_contenidos_subir_img', 0, '', NULL, 'N;'),
('action_contenidos_update', 0, '', NULL, 'N;'),
('action_contenidos_view', 0, '', NULL, 'N;'),
('action_cursos_admin', 0, '', NULL, 'N;'),
('action_cursos_agregarestudiantes', 0, '', NULL, 'N;'),
...
('action_default_create', 0, '', NULL, 'N;'),
('action_default_delete', 0, '', NULL, 'N;'),
('action_default_download', 0, '', NULL, 'N;'),
('action_default_index', 0, '', NULL, 'N;'),
('action_documento_view', 0, '', NULL, 'N;'),
('action_evaluacion_create', 0, '', NULL, 'N;'),
('action_grado_admin', 0, '', NULL, 'N;'),
('action_grado_create', 0, '', NULL, 'N;'),
('action_grado_delete', 0, '', NULL, 'N;'),
('action_grado_index', 0, '', NULL, 'N;'),
('action_grado_update', 0, '', NULL, 'N;'),
('action_grado_view', 0, '', NULL, 'N;'),
...
('action_usuarios_obtenerestudiantesajax', 0, '', NULL, 'N;'),
...
('invitado', 2, 'Invitado de la aplicación', '', 'N;'),
...
('invitado', 'action_contenidos_index'),
...
('invitado', 'action_contenidos_view'),
...
('invitado', 'action_imgvideossonido_index'),
...
('invitado', 'action_imgvideossonido_view'),
...
('invitado', 'action_talleres_index'),
...
('invitado', 'action_universidad_index'),
...
('invitado', 'action_universidad_view'),
...
(3, 'universidad', 'Universidad', 2, 1, 3, 20, 45, 0, '', '', 0x312c20506f6c6974c3a9636e69636f20436f6c6f6d6269616e6f204a61696d65204973617a6120436164617669640d0a322c2045414649540d0a332c20556e69766572736964616420646520416e74696f717569610d0a342c20556e697665727369646164206465204e6163696f6e616c20646520436f6c6f6d626961),
(4, 'telefono', 'Teléfono', 4, 1, 0, 20, 20, 0, '', '', ''),
(5, 'cel', 'Celular', 5, 0, 0, 20, 45, 0, '', '', ''),
(6, 'fechanac', 'Fecha de nacimiento', 6, 1, 0, 20, 45, 0, '', '', ''),
(7, 'materias', 'Materias', 7, 1, 3, 20, 45, 0, '', '', 0x312c204d6174656dc3a174696361730d0a322c2045737061c3b16f6c0d0a332c20205175c3ad6d6963610d0a342c2046c3ad73696361);
...
CREATE TABLE IF NOT EXISTS `math_fieldvalue` (
  ...
  KEY `fk_math_fieldvalue_math_user1` (`iduser`) USING BTREE,
  KEY `fk_math_fieldvalue_math_field1` (`idfield`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=8 ;

--
-- Volcado de datos para la tabla `math_fieldvalue`
--

INSERT INTO `math_fieldvalue` (`idfieldvalue`, `iduser`, `idfield`, `value`) VALUES
(1, 1, 1, 0x647373616464),
(2, 1, 2, 0x617364617364),
(3, 1, 3, 0x31),
(4, 1, 4, 0x33323134333234),
(5, 1, 5, ''),
(6, 1, 6, 0x30392f31322f31393931),
(7, 1, 7, 0x32);
...
CREATE TABLE IF NOT EXISTS `math_session` (
  ...
  KEY `mathsession_iduser` (`iduser`) USING BTREE
...
(6, 1, 1408426863, 1408428663, 1, '127.0.0.1', 1, 1408426863, NULL, NULL),
(7, 1, 1408580023, 1408581823, 0, '127.0.0.1', 1, 1408580023, 1408580154, '127.0.0.1'),
(8, 1, 1408580788, 1408582588, 1, '127.0.0.1', 1, 1408580788, NULL, NULL),
(9, 6, 1409246792, 1409248592, 0, '127.0.0.1', 1, 1409246792, 1409246814, '127.0.0.1'),
(10, 1, 1409246821, 1409248621, 1, '127.0.0.1', 1, 1409246821, NULL, NULL),
(11, 6, 1411620398, 1411622198, 0, '127.0.0.1', 1, 1411620398, 1411620455, '127.0.0.1'),
(12, 1, 1411620469, 1411622269, 0, '127.0.0.1', 1, 1411620469, NULL, NULL),
(13, 1, 1411643561, 1411645361, 0, '127.0.0.1', 1, 1411643561, NULL, NULL),
(14, 1, 1411645491, 1411647291, 0, '127.0.0.1', 1, 1411645491, NULL, NULL),
(15, 1, 1411694905, 1411696705, 0, '127.0.0.1', 1, 1411694905, NULL, NULL),
(16, 1, 1411700982, 1411702782, 0, '127.0.0.1', 1, 1411700982, NULL, NULL),
(17, 1, 1411706465, 1411708265, 0, '127.0.0.1', 1, 1411706465, NULL, NULL),
(18, 1, 1411708493, 1411710293, 0, '127.0.0.1', 1, 1411708493, NULL, NULL),
(19, 1, 1411711601, 1411713401, 0, '127.0.0.1', 1, 1411711601, NULL, NULL),
(20, 1, 1411713431, 1411715231, 0, '127.0.0.1', 1, 1411713431, NULL, NULL),
(21, 1, 1411731473, 1411733273, 0, '127.0.0.1', 1, 1411731473, NULL, NULL),
(22, 1, 1411784753, 1411786553, 0, '127.0.0.1', 1, 1411784753, NULL, NULL),
(23, 1, 1411828808, 1411830608, 0, '127.0.0.1', 1, 1411828808, NULL, NULL),
(24, 1, 1411836952, 1411838752, 0, '127.0.0.1', 1, 1411836952, 1411837170, '127.0.0.1'),
(25, 1, 1411838175, 1411839975, 0, '127.0.0.1', 2, 1411838870, NULL, NULL),
...
(33, 1, 1411841453, 1411843253, 0, '127.0.0.1', 1, 1411841453, NULL, NULL),
(34, 1, 1411847963, 1411849763, 0, '127.0.0.1', 1, 1411847963, 1411848002, '127.0.0.1'),
(35, 1, 1411848140, 1411849940, 1, '127.0.0.1', 1, 1411848140, NULL, NULL),
...
(39, 1, 1412036857, 1412038657, 0, '127.0.0.1', 1, 1412036857, NULL, NULL),
(40, 1, 1412038973, 1412050973, 0, '127.0.0.1', 1, 1412038973, NULL, NULL),
...
(50, 1, 1412072772, 1412084772, 0, '127.0.0.1', 1, 1412072772, NULL, NULL),
(51, 1, 1412099021, 1412111021, 1, '127.0.0.1', 1, 1412099021, NULL, NULL),
(52, 1, 1412121989, 1412133989, 0, '127.0.0.1', 1, 1412121989, NULL, NULL),
(53, 1, 1412135505, 1412147505, 0, '127.0.0.1', 1, 1412135505, NULL, NULL),
(54, 1, 1412169427, 1412181427, 1, '127.0.0.1', 1, 1412169427, NULL, NULL),
(55, 1, 1412208808, 1412220808, 0, '127.0.0.1', 1, 1412208808, NULL, NULL),
(56, 1, 1412221345, 1412233345, 0, '127.0.0.1', 1, 1412221345, NULL, NULL),
(57, 33, 1412230540, 1412242540, 0, '127.0.0.1', 1, 1412230540, 1412230666, '127.0.0.1'),
(58, 33, 1412230679, 1412242679, 1, '127.0.0.1', 1, 1412230679, NULL, NULL),
(59, 1, 1412233691, 1412245691, 0, '127.0.0.1', 1, 1412233691, NULL, NULL),
(60, 1, 1412250585, 1412262585, 1, '127.0.0.1', 1, 1412250585, NULL, NULL),
(61, 1, 1412292900, 1412304900, 0, '127.0.0.1', 1, 1412292900, NULL, NULL),
...
(65, 1, 1412309788, 1412321788, 0, '127.0.0.1', 1, 1412309788, NULL, NULL),
(66, 1, 1412335623, 1412347623, 0, '127.0.0.1', 1, 1412335623, NULL, NULL),
(67, 1, 1412385143, 1412397143, 0, '127.0.0.1', 1, 1412385143, NULL, NULL),
(68, 1, 1412398031, 1412410031, 0, '127.0.0.1', 1, 1412398031, NULL, NULL),
(69, 1, 1412419944, 1412431944, 0, '127.0.0.1', 1, 1412419944, 1412424824, '127.0.0.1'),
(70, 1, 1412424932, 1412436932, 1, '::1', 2, 1412435825, NULL, NULL),
(71, 1, 1413334127, 1413346127, 1, '::1', 2, 1413338567, NULL, NULL),
(72, 1, 1416878326, 1416890326, 0, '::1', 1, 1416878326, 1416880033, '::1'),
(73, 1, 1416880074, 1416892074, 0, '::1', 1, 1416880074, 1416885582, '::1'),
(74, 1, 1416886210, 1416898210, 0, '::1', 1, 1416886210, 1416886265, '::1'),
(75, 1, 1416968305, 1416980305, 1, '::1', 1, 1416968305, NULL, NULL),
(76, 1, 1417281142, 1417293142, 1, '::1', 1, 1417281142, NULL, NULL),
(77, 34, 1420862981, 1420874981, 0, '::1', 1, 1420862981, 1420863346, '::1'),
(78, 34, 1420864266, 1420876266, 0, '::1', 1, 1420864266, 1420864290, '::1'),
(79, 1, 1420864296, 1420876296, 0, '::1', 1, 1420864296, 1420864797, '::1'),
(80, 1, 1420864805, 1420876805, 1, '::1', 1, 1420864805, NULL, NULL),
(81, 1, 1420891363, 1420903363, 1, '::1', 1, 1420891363, NULL, NULL),
(82, 1, 1423094038, 1423106038, 1, '::1', 1, 1423094038, NULL, NULL),
(83, 1, 1423701113, 1423713113, 0, '::1', 1, 1423701113, 1423701245, '::1'),
(84, 1, 1423701265, 1423713265, 1, '::1', 2, 1423703626, NULL, NULL),
(85, 1, 1424308630, 1424320630, 1, '::1', 2, 1424312882, NULL, NULL),
(86, 1, 1424899372, 1424911372, 0, '::1', 2, 1424907107, NULL, NULL),
(87, 1, 1424915895, 1424927895, 1, '::1', 1, 1424915895, NULL, NULL),
(88, 1, 1425512990, 1425524990, 1, '::1', 1, 1425512990, NULL, NULL),
(89, 1, 1425683915, 1425695915, 0, '::1', 1, 1425683915, NULL, NULL),
(90, 1, 1425695933, 1425707933, 1, '::1', 1, 1425695933, NULL, NULL),
(91, 1, 1425943877, 1425955877, 1, '127.0.0.1', 2, 1425945602, NULL, NULL);
...
(1, NULL, NULL, 1425945602, 'admin', 'admin@tucorreo.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', NULL, 1, 0, 0),
(2, NULL, NULL, NULL, 'invitado', 'invitado', 'nopassword', NULL, 1, 0, 0),
(33, NULL, NULL, 1412230679, 'omesag', 'oscarmesa.elpoli@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', NULL, 1, 0, 0),
(34, NULL, NULL, 1420864266, 'dehost', 'ochoa8525@hotmail.com', '9a98af001a57b6a9f8013ae51acf8ac2a05b5cd8', NULL, 1, 0, 0),
(36, 1412425581, NULL, NULL, 'dehost', 'diego8525@gmail.com', 'b78e82e69823d05bf5219fbf9b7e91b1b5662787', '14fc10955e05b78e961d0480894370326b272f58', 1, 0, 0);
...
CREATE TABLE IF NOT EXISTS `respuestaejercicio` (
  ...
  KEY `fk_RespuestaEjercicio_contenidos1_idx` (`idContenido`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `respuestas_evaluado` (
  ...
  KEY `fk_ejercicios_has_evalucacion_integrante_evalucacion_integr_idx` (`evalucacion_integrante_id_evaluacion`,`evalucacion_integrante_id_integrante_curso`) USING BTREE,
  KEY `fk_ejercicios_has_evalucacion_integrante_ejercicios1_idx` (`ejercicios_id_ejercicio`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tema` (
  ...
  PRIMARY KEY (`idtema`),
  KEY `fk_tema_materias1_idx` (`idcurso`) USING BTREE,
  KEY `fk_idperiodo` (`idperiodo`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Mediate este campo podremos saber cual es el periodo al que pertenece el tema que se le esta cargando al curso' AUTO_INCREMENT=4 ;
...
(1, 'Estequiometría', 'Leyes fundamentales de la química. Teoría  atómica de Dalton. Hipótesis de\r\nAvogadro. Átomo. Molécula. Peso atómico. Peso molecular. Mol. Número de Avogadro. Volumen molar. Estequiometría.', 1, 1),
(2, 'norole', 'xc<z<zx<z asfas dfasdf asfs', 7, 1),
(3, 'dfsdfsdfds', 'sdfdsfsdf sdfsdf', 7, 2);
...
CREATE TABLE IF NOT EXISTS `tema_contenidos` (
  ...
  KEY `fk_tema_has_contenidos_contenidos1_idx` (`contenidos_id`) USING BTREE,
  KEY `fk_tema_has_contenidos_tema1_idx` (`tema_idtema`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tema_evaluaciones` (
  ...
  KEY `fk_tema_has_evaluaciones_evaluaciones1_idx` (`evaluaciones_id`) USING BTREE,
  KEY `fk_tema_has_evaluaciones_tema1_idx` (`tema_idtema`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tema_talleres` (
  ...
  KEY `fk_tema_has_talleres_talleres1_idx` (`talleres_idtalleres`) USING BTREE,
  KEY `fk_tema_has_talleres_tema1_idx` (`tema_idtema`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `usuarios_contenidos` (
  ...
  KEY `fk_usuarios_has_contenidos_contenidos1_idx` (`contenidos_id`) USING BTREE,
  KEY `fk_usuarios_has_contenidos_usuarios1_idx` (`usuarios_id_usuario`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `usuarios_profesion` (
  ...
  KEY `fk_usuarios_has_Profesion_Profesion1_idx` (`Profesion_id_profesion`) USING BTREE,
  KEY `fk_usuarios_has_Profesion_usuarios1_idx` (`id_usuario`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `usuario_universidades` (
  ...
  KEY `fk_docentes_has_universidades_docentes1` (`id_usuario`) USING BTREE,
  KEY `fk_usuario_universidades_universidad1` (`universidades_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `cursos`
  ADD CONSTRAINT `cursos_ibfk_1` FOREIGN KEY (`id_grado`) REFERENCES `grado` (`id_grado`) ON UPDATE CASCADE,
  ADD CONSTRAINT `cursos_ibfk_2` FOREIGN KEY (`id_docente`) REFERENCES `math_user` (`iduser`),
  ADD CONSTRAINT `cursos_ibfk_3` FOREIGN KEY (`idmateria`) REFERENCES `materias` (`idmaterias`);
...
ALTER TABLE `img_videos_sonido_contenidos`
  ...
  ADD CONSTRAINT `img_videos_sonido_contenidos_ibfk_2` FOREIGN KEY (`contenidos_id`) REFERENCES `contenidos` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `math_authassignment`
--
ALTER TABLE `math_authassignment`
  ADD CONSTRAINT `math_authassignment_ibfk_1` FOREIGN KEY (`itemname`) REFERENCES `math_authitem` (`name`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `math_authassignment_ibfk_2` FOREIGN KEY (`userid`) REFERENCES `math_user` (`iduser`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Filtros para la tabla `math_authitemchild`
--
ALTER TABLE `math_authitemchild`
  ADD CONSTRAINT `math_authitemchild_ibfk_1` FOREIGN KEY (`parent`) REFERENCES `math_authitem` (`name`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `math_authitemchild_ibfk_2` FOREIGN KEY (`child`) REFERENCES `math_authitem` (`name`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `math_fieldvalue`
--
ALTER TABLE `math_fieldvalue`
  ADD CONSTRAINT `math_fieldvalue_ibfk_1` FOREIGN KEY (`idfield`) REFERENCES `math_field` (`idfield`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `math_fieldvalue_ibfk_2` FOREIGN KEY (`iduser`) REFERENCES `math_user` (`iduser`) ON DELETE CASCADE ON UPDATE NO ACTION;
...
--
ALTER TABLE `tema`
  ADD CONSTRAINT `tema_ibfk_1` FOREIGN KEY (`idcurso`) REFERENCES `cursos` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tema_ibfk_2` FOREIGN KEY (`idperiodo`) REFERENCES `periodo` (`id_periodo`) ON UPDATE CASCADE;
