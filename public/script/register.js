...
var sw = 0;
	...
	if($("#cotranuevousuario2").val()!="" && $("#cotranuevousuario").val()!="")
	{
		...
		{
			$("#mensaje_cotranuevousuario2").html('<span style="color:red;font-size:16px">* No coincide la contraseña</span>');
			$("#mensaje_cotranuevousuario").html('<span style="color:red;font-size:16px">* No coincide la contraseña</span>');
			sw = 1
		}
	}
