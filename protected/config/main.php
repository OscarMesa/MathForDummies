    ...
    'modules' => array(
        'jbackup' => array(
            ...
            'directoryBackup' => array(
                ...
                'themes/OzAuLink/' => __DIR__ . '/../../themes/OzAuLink/',
            ),
...
// en vez de 'default' pon 'authdemo' para que utilice el demo de autenticacion alterna
           ...
           'availableAuthMethods' => array('default'),
            ...
            'baseUrl' => $_SERVER['HTTP_HOST'] . '/OzAuLink',
...
//               'programa/ActualizaEstado/<programa>/<estado>' => 'programa/ActualizaEstado'
        ...
        'db' => array(
            'connectionString' => 'mysql:host='.MYSQL_HOST.';dbname='.MYSQL_DB.';unix_socket:/path/to/socket/mysql.sock',
            'emulatePrepare' => true,
            'username' => MYSQL_USER,
            'password' => MYSQL_PASS,
            'charset' => 'utf8',
