 ...
 */
class NotaSeguimientoUsuario extends Model {
    ...
    public function validateIntervale($attribute, $params)
    {
        if($this->nota < 1 || $this->nota > 5 )
        $this->addError($attribute, Yii::t('polimsn','The note should be in the range of 1-5.'));
    }
    ...
    public function attributeLabels() {
        return array(
            'id' => 'ID',
            'id_usuario' => 'Usuario',
            'id_seguimiento_usuario_curso' => 'Seguimiento',
            'nota' => 'Nota',
