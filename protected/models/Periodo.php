...
class Periodo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('valor_numerico', 'required'),
			array('valor_numerico', 'numerical', 'integerOnly'=>true),
			array('valor_textual', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_periodo, valor_numerico, valor_textual', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('valor_textual',$this->valor_textual,true);
