...
class TipoEvaluacion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tipo_evaluacion', 'required'),
			array('tipo_evaluacion', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('tipoid, tipo_evaluacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'tipoid' => 'Tipoid',
			'tipo_evaluacion' => 'Tipo Evaluacion',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('tipo_evaluacion',$this->tipo_evaluacion,true);
