<ul class="nav nav-tabs">
    ...
    <li class="<?php echo isset($activeAdmin) && $activeAdmin ? 'active':''; ?>"><a href="<?php echo Yii::app()->getBaseUrl(true) ?>/seguimientoUsuarioCurso/notas/<?php echo isset($model->curso)?$model->curso->id:$model->id; ?>"><i class="icon-briefcase"></i>&nbsp;Notas</a></li>
</ul>
