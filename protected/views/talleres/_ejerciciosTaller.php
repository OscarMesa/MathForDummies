...
<div class="panel panel-success ejercicio" style="">
    ...
    <?php }else{ ?>    
      <div class="checkbox"><?php echo CHtml::checkBox('Taller[ejercicios][check]['.$data->id_ejercicio.']', 0, array('value'=>$data->id_ejercicio))?>
    <?php } ?>      
          <a class="full-scream-ejercicio" href="#" onclick="AbrirModal('Ejercico #<?php echo $data->id_ejercicio;?>','500px','90%','<?php echo Yii::app()->createAbsoluteUrl('ejercicios/view', array('id'=>$data->id_ejercicio)); ?>','left: 55%')"><i class="icon-fullscreen"></i></a>  </div>
    </div>
