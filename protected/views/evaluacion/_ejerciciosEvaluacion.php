...
<div class="panel panel-success ejercicio" style="">
    ...
    <?php }else{ ?>    
      <div class="checkbox"><?php echo CHtml::checkBox('Evaluacion[ejercicios][check]['.$data->id_ejercicio.']', 0, array('value'=>$data->id_ejercicio))?>
    <?php } ?>      
          <a class="full-scream-ejercicio" href="#" onclick="AbrirModal('Ejercico #<?php echo $data->id_ejercicio;?>','500px','90%','<?php echo Yii::app()->createAbsoluteUrl('contenidos/view', array('id'=>$data->id_ejercicio)); ?>')"><i class="icon-fullscreen"></i></a>  </div>
    </div>
