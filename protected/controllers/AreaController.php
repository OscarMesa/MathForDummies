...
// if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser
    ...
    public function actionListarAreasAjax()
    {
        $term = $_REQUEST['term'];
        $areas = Area::model()->findAll('descripcion LIKE ?',array("%".$term."%"));
        $result = array();
        foreach ($areas as $area) {
            $result[] = array('id'=>$area->id_area,'text'=>$area->descripcion);
        }
